...
namespace TestPostBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Method;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Route;
use TestPostBundle\Entity\Post;
use TestPostBundle\Form\PostType;
...
class PostController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $posts = $em->getRepository('TestPostBundle:Post')->findAll();
    ...
    {
        $post = new Post();
        $form = $this->createForm('TestPostBundle\Form\PostType', $post);
    ...
    {
        $deleteForm = $this->createDeleteForm($post);
        $editForm = $this->createForm('TestPostBundle\Form\PostType', $post);
